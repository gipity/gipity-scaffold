...
export const About: React.FC = () => {
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Getting Started */}
      <Card className="bg-gradient-to-r from-[#476A92]/5 to-[#476A92]/10 border-[#476A92]/20">
        <CardContent className="pt-6">
          <div className="text-center space-y-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">Ready to Build Your MVP?</h3>
              <p className="text-gray-600 dark:text-gray-400">
                This scaffold provides everything you need to launch a production app in days, not months
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button className="bg-[#476A92] hover:bg-[#3d5c82]">
                <Zap className="w-4 h-4 mr-2" />
                Fork This Project
              </Button>
              <Button variant="outline" className="hover:bg-gray-50 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-100">
            ...
            <div className="border-t pt-6 space-y-4">
              <p className="text-gray-600 dark:text-gray-400">
                ...
                <a 
                  ...
                  className="text-[#476A92] hover:text-[#3d5c82] font-medium underline"
                >
                  Gipity
                </a>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border">
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                  <span className="font-medium">Need custom development?</span>
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-500">
                  Get professional help extending this scaffold into your unique product vision
                </p>
              </div>
            </div>
          </div>
